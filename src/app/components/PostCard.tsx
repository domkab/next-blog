  ...
  return (
    <div className='group relative w-full border border-teal-500 hover:border-2 h-[420px] overflow-hidden rounded-lg sm:w-[430px] transition-all'>
      ...
      <div className='p-3 flex flex-col gap-2'>
        ...
        <p className='text-sm'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quod saepe voluptates adipisci commodi fugit quisquam nam provident dolor consequuntur molestias?</p>
        <Link
          href={`/post/${post.slug}`}
